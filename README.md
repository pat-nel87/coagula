...
```powershell
pip install https://github.com/pat-nel87/coagula/releases/download/v0.3.9/coagula-0.3.9-py3-none-any.whl
...
**v0.3.9** — Seven-stage funnel, CLI, MCP adapter library, and a standalone
...
# With MCP server:
pip install "coagula[mcp] @ https://github.com/pat-nel87/coagula/releases/download/v0.3.9/coagula-0.3.9-py3-none-any.whl"
